...
//projects
	...
	if(!config_setting_set_string(prop_modules, "./plugins/projects/projects.so"))goto fail_exit;
//git
	if((prop_modules=config_setting_add(config_prop, "", CONFIG_TYPE_STRING))==NULL) goto fail_exit;
	if(!config_setting_set_string(prop_modules, "./plugins/git/git.so"))goto fail_exit;
//dummy
	if((prop_modules=config_setting_add(config_prop, "", CONFIG_TYPE_STRING))==NULL) goto fail_exit;
	if(!config_setting_set_string(prop_modules, "./plugins/dummy/dummy.so"))goto fail_exit;

//luadummy
	if((prop_modules=config_setting_add(config_prop, "", CONFIG_TYPE_STRING))==NULL) goto fail_exit;
	if(!config_setting_set_string(prop_modules, "./plugins/luadummy/luadummy.lua"))goto fail_exit;
